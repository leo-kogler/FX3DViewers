...
public class AnimatedZoomOperator {
    ...
    public void zoom(Node node, double factor, double x, double y, double z) {    
        // determine scale
        ...
        double dz = (z - (bounds.getDepth() / 2 + bounds.getMinZ()));
        ...
        timeline.getKeyFrames().addAll(
            ...
            new KeyFrame(Duration.millis(200), new KeyValue(node.translateYProperty(), node.getTranslateZ() - f * dz)),
            ...
            new KeyFrame(Duration.millis(200), new KeyValue(node.scaleZProperty(), scale))
        );
        timeline.play();
    }
}